...
var handleDonutChart = function() {
    ...
    if ($('#donut-chart').length !== 0) {
        var donutData = [
            { label: "Boots", data: 35, color: COLOR_PURPLE_DARKER },
            { label: "Overall", data: 30, color: COLOR_PURPLE },
            { label: "Sigurgical mask", data: 15, color: COLOR_PURPLE_LIGHTER },
            { label: "Protection glasses", data: 10, color: COLOR_BLUE },
            { label: "Gloves", data: 5, color: COLOR_BLUE_DARKER }
        ];
...
var Dashboard = function() {
    ...
    return {
        ...
        init: function() {
            ...
            // $('.colorpicker-picker-longlist').simplecolorpicker({ picker: true, theme: 'glyphicons' });
        }
    };
}();
